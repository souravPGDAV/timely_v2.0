const register={
    template:`
        ...
        <div class="container mt-1" >
            <h3 align="center" class ="display-6">Registration</h3>
        </div>
        ...
        <div class="container p-2 my-5 border" align="center" v-if="loaded!=false && all_registered==false">
            ...
            <h6>The Code provided to you was:</h6>
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-sm">
                            ...
                            <label>Phone (WhatsApp enabled):
                                <input type="tel" v-model="phone" :disabled="!loaded" pattern="[0-9]{10}" required/>
                            </label>
                        </div>
                    </div>
                    <div class="row">
    ...
    methods:{
       ...
       get_t_details:async function(e){
                    fetch(this.$store.getters.get_base_url+"/api/teachers")
                        .then(resp=>{
       ...
       registerSubmit:function(e){
           ...
           // else{
            ...
            fetch(this.$store.getters.get_base_url+"/register",{ method:'POST',
                 body: data })
             .then(resp=>{
                this.loaded=true
                if(!resp.ok){
